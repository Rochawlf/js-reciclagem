...
@section('title', 'Acondicionamento e Destinação | JS Reciclagem')

@section('content')

    <header class="relative pt-36 pb-28 md:pt-44 md:pb-40 bg-gray-950 overflow-hidden flex items-center min-h-[78vh]">
        <div class="absolute inset-0 z-0">
            <img src="{{ asset('img/banner.jpeg') }}" alt="Acondicionamento e destinação correta de resíduos"
    ...
    <main id="conteudo">
        ...
        <section class="py-24 bg-white dark:bg-black overflow-hidden border-b border-gray-100 dark:border-gray-800">
            <div class="container mx-auto px-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="grid grid-cols-2 gap-5 reveal-zoom">
                        <div class="space-y-5">
                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/01.jpeg') }}"
                            ...
                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/02.jpeg') }}"
                        ...
                        <div class="space-y-5 pt-12">
                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/03.jpeg') }}"
                                alt="Gerenciamento ambiental de resíduos"
                                class="w-full h-80 object-cover rounded-3xl shadow-2xl hover:scale-[1.02] transition duration-700">
                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/04.jpeg') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
                    <div class="w-full reveal-zoom">
                        <div class="image-wrapper">
                            ...
                            <div class="image-container aspect-[4/3] rounded-2xl shadow-xl overflow-hidden">
                                <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/05.jpeg') }}"
                    ...
                    <div class="w-full reveal delay-100">
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 font-medium space-y-3">
                            ...
                            <li><i class="fas fa-check text-brand mr-2"></i> Alta resistência para resíduos industriais e
                                sucatas</li>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
                    <div class="w-full md:order-2 reveal-zoom">
                        <div class="image-wrapper">
                            ...
                            <div class="image-container aspect-[4/3] rounded-2xl shadow-xl overflow-hidden">
                                <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/06.jpeg') }}"
                    ...
                    <div class="w-full md:order-1 reveal delay-100">
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 font-medium space-y-3">
                            <li><i class="fas fa-check text-brand mr-2"></i> Acondicionamento seguro de resíduos específicos
                            </li>
                            <li><i class="fas fa-check text-brand mr-2"></i> Redução de riscos de vazamentos e contaminação
                            </li>
                            <li><i class="fas fa-check text-brand mr-2"></i> Melhor controle para armazenamento temporário
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div class="w-full reveal-zoom">
                        <div class="image-wrapper">
                            <div class="circle-arc"></div>
                            <div class="image-container aspect-[4/3] rounded-2xl shadow-xl overflow-hidden">
                                <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/07.jpeg') }}"
                    ...
                    <div class="w-full reveal delay-100">
                        ...
                        <ul class="text-gray-600 dark:text-gray-400 font-medium space-y-3">
                            ...
                            <li><i class="fas fa-check text-brand mr-2"></i> Redução de volume de papelão, plástico e
                                materiais recicláveis</li>
                            <li><i class="fas fa-check text-brand mr-2"></i> Melhor organização e eficiência operacional
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section class="py-24 bg-gray-100 dark:bg-[#080808] overflow-hidden border-b border-gray-200 dark:border-gray-800">
            <div class="container mx-auto px-6">
                ...
                <div class="space-y-24">
                    @foreach ($solucoesIndustriais as $solucao)
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">

                            <div class="{{ $solucao['ordem'] === 'reverse' ? 'lg:order-2' : '' }} reveal-zoom">
                                <div class="grid grid-cols-2 gap-4">
                                    @foreach ($solucao['imagens'] as $index => $imagem)
                                        <div class="group relative overflow-hidden rounded-3xl shadow-2xl bg-gray-200 dark:bg-gray-900
                                                {{ $index === 1 ? 'mt-8' : '' }}
                                                {{ $index === 2 ? '-mt-4' : '' }}">
                                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/' . $imagem) }}"
                                                alt="{{ $solucao['titulo'] }} - imagem {{ $index + 1 }}"
                            ...
                            <div class="{{ $solucao['ordem'] === 'reverse' ? 'lg:order-1' : '' }} reveal">
                                <span
                                    ...
                                    <i class="{{ $solucao['icone'] }} text-2xl"></i>
                                    Solução industrial
                                </span>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    @for ($i = 1; $i <= 21; $i++)
                        <div
                            ...
                            <img src="{{ asset('img/Acondicionamento de resíduos e destinação correta/' . str_pad($i, 2, '0', STR_PAD_LEFT) . '.jpeg') }}"
                                alt="Imagem {{ $i }} - Acondicionamento e destinação correta"
