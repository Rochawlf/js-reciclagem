<?php
$pageTitle = 'Serviços e Produtos | JS Reciclagem LTDA';
    ...
    <main>
        ...
        <header class="relative pt-36 pb-28 md:pt-44 md:pb-40 bg-gray-950 overflow-hidden flex items-center min-h-[78vh]">
            <div class="absolute inset-0 z-0">
                <img src="img/banner.jpeg" alt="Serviços e Produtos JS Reciclagem"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div class="reveal-zoom">
                        <div class="relative min-h-[420px] md:min-h-[520px] flex items-center justify-center">
                            ...
                            <img src="img/servicos/01.png" alt="Serviços especializados JS Reciclagem"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
                    ...
                    <div class="reveal-zoom">
                        <div
                            ...
                            <img src="img/servicos/02.png" alt="Soluções industriais JS Reciclagem"
